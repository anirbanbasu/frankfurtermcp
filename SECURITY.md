...
The FrankfurterMCP project and its maintainers take security vulnerabilities seriously.
...
If you think you have identified a security issue with the FrankfurterMCP project, _do not open a public issue_. To responsibly report a security issue, please navigate to the "Security" tab for the repository, and click "[Report a vulnerability](https://github.com/anirbanbasu/frankfurtermcp/security/advisories/new)".
...
While using FrankfurterMCP, we recommend:
